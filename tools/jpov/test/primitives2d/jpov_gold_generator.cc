...
//
// 输出: /james_pm/ai_infra/tools/jpov/test/primitives2d/rect_centered_blue_640x360.png
...
int main() {
    const char* outpath = "/james_pm/ai_infra/tools/jpov/test/primitives2d/rect_centered_blue_640x360.png";
