// JPOV Gold Image Generator — PBR Cube Normal 纹理映射
//
...
//
// 输出: tools/jpov/test/object3d/pbr_cube_normal_1280x720.png
...
class PbrCubeNormalGenerator : public JPOV {
public:
    using JPOV::JPOV;
...
int main() {
    const char* outpath =
        "/james_pm/ai_infra/tools/jpov/test/object3d/pbr_cube_normal_1280x720.png";

    JPOV::Config cfg;
    cfg.title = "PBR Cube Normal Gold Generator";
    cfg.headless = true;
    PbrCubeNormalGenerator app(cfg);
    app.Init();
