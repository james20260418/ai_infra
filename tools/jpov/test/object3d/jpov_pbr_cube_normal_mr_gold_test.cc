...
std::string GetGoldPath() {
    ...
    if (test_srcdir) {
        std::string p = test_srcdir;
        if (!p.empty() && p.back() != '/') p.push_back('/');
        p += "__main__/tools/jpov/test/object3d/pbr_cube_normal_mr_1280x720.png";
        return p;
    }
    return jpov::GetProjectRoot() +
        "tools/jpov/test/object3d/pbr_cube_normal_mr_1280x720.png";
}
...
int main() {
    ...
    std::string outdir = jpov::GetOutputDir() + "jpov_pbr_cube_normal_mr_test/";
