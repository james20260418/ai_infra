...
class PbrEmissiveGoldGenerator : public JPOV {
public:
    using JPOV::JPOV;
...
int main() {
    ...
    cfg.headless = true;
    PbrEmissiveGoldGenerator app(cfg);
    app.Init();
    ...
    LOG(INFO) << "PBR emissive gold image generated: " << outpath;
    return 0;
}
