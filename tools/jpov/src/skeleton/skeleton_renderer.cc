...
void SkeletonRenderer::EnsureTileLighting(int fbo_w, int fbo_h,
...
void SkeletonRenderer::UploadLightData(const RenderCommandList& cmds,
...
void SkeletonRenderer::BuildTileLightIndices(const RenderCommandList& cmds,
                                             int fbo_w, int fbo_h,
...
void SkeletonRenderer::DrawObject3D(const Object3DCommand& cmd,
...
// 带骨渲染（SkeletonRenderer 升级）：抄 DrawObject3D 本体，改成用蒙皮 program 画，
...
void SkeletonRenderer::DrawObject3DInstancedWithSkeleton(
...
void SkeletonRenderer::DrawObject3DShadow(const Object3DCommand& cmd,
                                          MeshManager& mesh_mgr,
                                          ShaderManager& shader_mgr,
