...
echo ""
echo "   4. 材质单变量覆盖（headless 批量跑用，缺省不改）："
echo "       --area_density R  --hooke T  --arap B  --damping U  --gravity G  --substeps N"
echo "       例：--gravity 0（关重力）/ --area_density 100（质量×100 抗自重下垂）"
echo ""
...
echo "     底部 5 滑条：太阳仰角 / 浊度 / 季节 R / 地面高度 y / **重力 g（默认 1.0）**"
echo "   材质固定在代码里：面密度 1 kg/m² / 胡克 100 N/m（0.1 m ⇒ 10 N）/ ARAP T/7 / 阻尼 0.6"
