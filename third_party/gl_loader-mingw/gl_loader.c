...
int gl_loader_init(void) {
    ...
    LOAD_FUNC(gl_GenRenderbuffers,        "glGenRenderbuffers");
    LOAD_FUNC(gl_DeleteRenderbuffers,     "glDeleteRenderbuffers");
    LOAD_FUNC(gl_BindRenderbuffer,        "glBindRenderbuffer");
    LOAD_FUNC(gl_RenderbufferStorage,     "glRenderbufferStorage");
    LOAD_FUNC(gl_FramebufferRenderbuffer, "glFramebufferRenderbuffer");
...
DEFINE_PTR(GL_GenRenderbuffers,        gl_GenRenderbuffers);
DEFINE_PTR(GL_DeleteRenderbuffers,     gl_DeleteRenderbuffers);
DEFINE_PTR(GL_BindRenderbuffer,        gl_BindRenderbuffer);
DEFINE_PTR(GL_RenderbufferStorage,     gl_RenderbufferStorage);
DEFINE_PTR(GL_FramebufferRenderbuffer, gl_FramebufferRenderbuffer);
