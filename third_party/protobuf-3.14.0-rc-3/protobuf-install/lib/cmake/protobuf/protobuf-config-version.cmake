set(PACKAGE_VERSION "3.14.0.3")
set(${PACKAGE_FIND_NAME}_VERSION_PRERELEASE "3" PARENT_SCOPE)
...
if(PACKAGE_FIND_VERSION) #Only perform version checks if one is given
  ...
  elseif(PACKAGE_FIND_VERSION VERSION_EQUAL PACKAGE_VERSION)
    # Do not match prerelease versions to non-prerelease version requests.
      if(NOT "3" STREQUAL "" AND PACKAGE_FIND_VERSION_PRERELEASE STREQUAL "")
      message(AUTHOR_WARNING "To use this prerelease version of ${PACKAGE_FIND_NAME}, set ${PACKAGE_FIND_NAME}_FIND_VERSION_PRERELEASE to '3' or greater.")
      set(PACKAGE_VERSION_COMPATIBLE FALSE)
    endif()

    # Not robustly SemVer compliant, but protobuf never uses '.' separated prerelease identifiers.
    if(PACKAGE_FIND_VERSION_PRERELEASE STRGREATER "3")
      set(PACKAGE_VERSION_COMPATIBLE FALSE)
    endif()
  endif()
endif()
